...
public class Ex05AvailableSortWithItem {
	public static void main(String[] args) {
		...
		// Khi dùng hàm Arrays.sort(object); thì thằng object của mảng mình truyền 
		// phải là con của Comparable và phải override lại hàm compare.
		// Còn string là một class có sẵn của java nên mình không cần làm.
		// 1. Sorting item descending by storeId
		Arrays.sort(items);
		ArrayUtils.printf("1. Sorting item descending by storeId", items);
		
		// Dùng Comparator vì --> Comparable(support for one sort function)
